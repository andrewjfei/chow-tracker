const styles = {
  button: {
    base: 'flex flex-row justify-center items-center px-2 py-2 border-2 rounded-lg text-sm font-semibold transition-colors hover:cursor-pointer focus:outline-none focus:border-orange-600',
    filled: {
      default:
